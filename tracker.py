...
class Tracker:
    ...
    def _load_or_create(self):
        # No data file, or an empty data file -> create fresh data.
        ...
        try:
            ...
            raise RuntimeError(
                "data.json is corrupted and no usable backup exists."
            )
    ...
    def _save(self, data=None):
        ...
        # Create backup of the current file before replacing it.
        if DATA_FILE.exists():
    ...
    def _ask_menu_choice(self, prompt, minimum, maximum):
        while True:
    ...
    def _buy_has_been_sold(self, buy_transaction_id):
        for transaction in self.data["transactions"]:
            ...
            for allocation in transaction.get(
                ...
                if allocation["buy_transaction_id"] == buy_transaction_id:
                    return True
    ...
    def delete_transaction(self, transaction_id):
        ...
        if transaction["type"] == "BUY":
            ...
            if self._buy_has_been_sold(
                ...
                print(
                    "Some of its inventory has already "
                    "been sold."
                )
    ...
    def edit_transaction(self, transaction_id):
        ...
        # A BUY that has already been consumed by a SELL
        # cannot be edited safely in V1.
        if transaction["type"] == "BUY":
            if self._buy_has_been_sold(transaction_id):
                print()
                print("This BUY cannot be edited.")
                print("Some of its inventory has already been sold.")
                print()
                print("Delete/edit the dependent SELL transactions")
                print("first if you want to change this BUY.")
        ...
        print()
        print("The original transaction will be deleted")
        print("and replaced with a new transaction.")
        ...
        print("Enter the replacement transaction.")
        print()
    ...
    def manage_transactions(self):
        ...
        transaction_id = self._ask_nonnegative_int(
            "> "
        )
    ...
    def show_unrealized_profit(self):
        ...
        for item_id, batches in inventory.items():
            ...
            print(f"Potential revenue: {revenue:,}c")
            print(f"Unrealized profit: {profit:+,}c")
        ...
        if not found_inventory:
            ...
            print(f"Potential revenue: {total_revenue:,}c")
            print(
                f"Unrealized profit: "
    ...
    def show_profit(self):
        ...
        for transaction in transactions:
            ...
            if transaction["type"] == "SELL":
                total_sell_revenue += transaction["total_chaos"]
                total_fifo_cost += transaction["fifo_cost"]
                realized_profit += transaction["profit"]
    ...
    def run(self):
        ...
        while True:
            ...
            choice = self._ask_menu_choice("> ", 1, 9)
        ...
        for transaction in transactions:
            ...
            if transaction["type"] == "BUY":
                ...
                inventory[item_id].append({
                    ...
                    "unit_cost_chaos": transaction["unit_price_chaos"],
            ...
            # -----------------
                ...
                quantity_to_remove = transaction["quantity"]
    ...
    def _edit_divine_rate(self):
        ...
        print(
            f"Current: "
            f"1 Divine = {current['chaos_value']} Chaos"
        )
    ...
    def _calculate_fifo(self, item_id, quantity):
        inventory = self._build_inventory()
    ...
    def add_transaction(self):
        ...
        transaction_type = self._select_transaction_type()
        ...
        if currency == "CHAOS":
            ...
            chaos_price = self._divine_to_chaos(price)
        ...
        total_chaos = chaos_price * quantity
        ...
        if transaction_type == "SELL":
            ...
            fifo_allocations, fifo_cost = fifo_result
        ...
        transaction = {
            ...
            "unit_price_chaos": chaos_price,

            "total_chaos": total_chaos,

            "gold_spent": gold_spent,
            "gold_chaos": gold_chaos,
        ...
        print()
        print(
            f"Transaction #{transaction['id']} saved."
        )
